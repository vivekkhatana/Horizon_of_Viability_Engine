# -*- coding: utf-8 -*-
"""
Created on Mon Nov 15 12:14:15 2021 
...
### LOG FILE LOCATIONS ###
SCENARIO_LOG_FILENAME = "hovLog_SDP_nuc_norm.csv" #log file where
   ...
   # 5. STEP 3 WILL REQUIRE YOU TO FIGURE OUT SHOULD THIS BE A COST OR A SEPARATE SUB-ROUTINE
    ...
    if HoV_ON == 1:   
        if np.max(SOC) > SOCmin or np.max(SOE) > SOEmin:
            ...
            prob.solve(solver = cvx.MOSEK, verbose=True, warm_start=True)
